...
const SystemSettingsSchema = new mongoose.Schema({
  ...
  socialMedia: {
    ...
    linkedin: { type: String, default: 'https://linkedin.com/company/neuromphis' },
  ...
  features: {
    ...
    newsComments: { type: Boolean, default: false },
    projectCollaboration: { type: Boolean, default: true },
  }
});
